...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    @foreach($dokter as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">{{$data->namadkt}} -
                <a href="/dokter/{{$data->kodedkt}}">{{$data->kodedkt}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Spesialis : </b>{{$data->spesialis}}</p>
              <p><b>Alamat : </b>{{$data->alamatdkt}}</p>
              <p><b>Telepon : </b>{{$data->telepondkt}}</p>
              <p><b>Poliklinik : </b>{{$data->poliklinik->namaplk}}</p>
              <p><b>Tarif : </b>{{$data->tarif}}</p>
              <form action="/dokter/{{$data->kodedkt}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/dokter/{{$data->kodedkt}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$dokter->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
