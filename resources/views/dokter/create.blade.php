...
<form action="/dokter" method="POST">
			   ...
			   <div class="form-group">
                  <label>Nama </label>
                  <input type="text" name="namadkt" placeholder="namadkt" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  <label>Alamat </label>
                  <input type="text" name="alamatdkt" placeholder="alamatdkt" class="form-control">
              </div>
              <div class="form-group">
                  <label>Telepon </label>
                  <input type="text" name="telepondkt" placeholder="telepondkt" class="form-control">
              </div>
