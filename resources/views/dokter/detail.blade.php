...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="/dokter/search" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="/dokter"><i class="fa fa-user"></i> <span>Dokter</span><span class="pull-right-container">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/dokter/create">Input</a></small>
      </h1>
    </section>
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">{{$dokter->namadkt}} -
                <a href="/dokter/{{$dokter->kodedkt}}">{{$dokter->kodedkt}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Spesialis : </b>{{$dokter->spesialis}}</p>
              <p><b>Alamat : </b>{{$dokter->alamatdkt}}</p>
              <p><b>Telepon : </b>{{$dokter->telepondkt}}</p>
              <p><b>Poliklinik : </b>{{$dokter->poliklinik->namaplk}}</p>
              <p><b>Tarif : </b>{{$dokter->tarif}}</p>
              <form action="/detail/{{$dokter->kodedkt}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/detail/{{$dokter->kodedkt}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
              <button type="submit" class="btn btn-default btn-xs btn-danger" value="Delete"><i class="fa fa-times"></i>Delete</button>
              </form>
              <span class="pull-right text-muted">
              Created At - {{$dokter->created_at}}</span>
