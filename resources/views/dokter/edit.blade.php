  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="/dokter"><i class="fa fa-user"></i> <span>Dokter</span>
...
<form action="/dokter/{{$dokter->kodedkt}}" method="POST">
			   ...
			   <div class="form-group">
                  <label>Nama </label>
                  <input type="text" name="namadkt" placeholder="namadkt" class="form-control" value="{{$dokter->namadkt}}">
              </div>
              <div class="form-group">
                  <label>Spesialis </label>
                  <input type="text" name="spesialis" placeholder="spesialis" class="form-control" value="{{$dokter->spesialis}}">
              </div>
              <div class="form-group">
                  <label>Alamat </label>
                  <input type="text" name="alamatdkt" placeholder="alamatdkt" class="form-control" value="{{$dokter->alamatdkt}}">
              </div>
              <div class="form-group">
                  <label>Telepon </label>
                  <input type="text" name="telepondkt" placeholder="telepondkt" class="form-control" value="{{$dokter->telepondkt}}">
              </div>
		...
		@if($dokter->poliklinik_id == $data->kodeplk)
			selected 
		@endif
		>{{$data->namaplk}}</option>
	@endforeach
			...
			<div class="form-group">
                  <label>Tarif </label>
                  <input type="text" name="tarif" placeholder="tarif" class="form-control" value="{{$dokter->tarif}}">
              </div>
			</div>
