...
<form action="/pasien" method="POST">
			   ...
			   <div class="form-group">
                  ...
                  <input type="text" name="namapsn" placeholder="namapsn" class="form-control">
              </div>
              <div class="form-group">
                  <label>Alamat </label>
                  <input type="text" name="alamatpsn" placeholder="alamatpsn" class="form-control">
              </div>
              <div class="form-group">
                  <label>Gender </label>
              ...
              <div class="form-group">
                  <label>Umur </label>
                  <input type="text" name="umurpsn" placeholder="umurpsn" class="form-control">
              </div>
			<div class="form-group">
                  <label>Telepon </label>
                  <input type="text" name="teleponpsn" placeholder="teleponpsn" class="form-control">
              </div>
			</div>
