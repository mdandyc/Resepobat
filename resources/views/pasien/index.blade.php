...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    @foreach($pasien as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">{{$data->namapsn}} -
                <a href="/pasien/{{$data->kodepsn}}">{{$data->kodepsn}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Alamat : </b>{{$data->alamatpsn}}</p>
              <p><b>Gender : </b>{{$data->genderpsn}}</p>
              <p><b>Umur Pasien : </b>{{$data->umurpsn}}</p>
              <p><b>Telepon : </b>{{$data->teleponpsn}}</p>
              <form action="/pasien/{{$data->kodepsn}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/pasien/{{$data->kodepsn}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$pasien->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
