...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/pasien/create">Input</a></small>
      </h1>
    </section>
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">{{$pasien->namapsn}} -
                <a href="/pasien/{{$pasien->kodepsn}}">{{$pasien->kodepsn}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Alamat : </b>{{$pasien->alamatpsn}}</p>
              <p><b>Gender : </b>{{$pasien->genderpsn}}</p>
              <p><b>Umur Pasien : </b>{{$pasien->umurpsn}}</p>
              <p><b>Telepon : </b>{{$pasien->teleponpsn}}</p>
              <form action="/pasien/{{$pasien->kodepsn}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/pasien/{{$pasien->kodepsn}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
              <button type="submit" class="btn btn-default btn-xs btn-danger" value="Delete"><i class="fa fa-times"></i>Delete</button>
              </form>
              <span class="pull-right text-muted">
              Created At - {{$pasien->created_at}}</span>
