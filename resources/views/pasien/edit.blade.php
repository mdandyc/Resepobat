...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="/pasien/search" method="get" class="sidebar-form">
...
@endif
<form action="/pasien/{{$pasien->kodepsn}}" method="POST">

		
			   <div class="form-group">
                  <label>Nama Pasien </label>
                  <input type="text" name="namapsn" placeholder="namapsn" class="form-control" value="{{$pasien->namapsn}}">
              </div>
              <div class="form-group">
                  <label>Alamat </label>
                  <input type="text" name="alamatpsn" placeholder="alamatpsn" class="form-control" value="{{$pasien->alamatpsn}}">
              </div>
              <div class="form-group">
                  <label>Gender </label>
                  <select name="genderpsn" id="" class="form-control">
                  	<option value="Laki-Laki"
                  	@if ($pasien->genderpsn == 'Laki-Laki')
                  		selected 
                  	@endif
                  	>Laki-Laki</option>
                  	<option value="Perempuan"
                  	@if ($pasien->genderpsn == 'Perempuan')
                  		selected 
                  	@endif
                  	>Perempuan</option>
                  </select>
              ...
              <div class="form-group">
                  <label>Umur </label>
                  <input type="text" name="umurpsn" placeholder="umurpsn" class="form-control" value="{{$pasien->umurpsn}}">
              </div>
			<div class="form-group">
                  <label>Telepon </label>
                  <input type="text" name="teleponpsn" placeholder="teleponpsn" class="form-control" value="{{$pasien->teleponpsn}}">
              </div>
			</div>
