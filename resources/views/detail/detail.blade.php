          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">ID Detail -
                <a href="/detail/{{$detail->id}}">{{$detail->id}}</a>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Nama Obat : </b>{{$detail->obat->namaobat}}</p>
              <p><b>Nomor Resep : </b>{{$detail->resep->nomorresep}}</p>
              <p><b>Harga : </b>{{$detail->harga}}</p>
              <p><b>Dosis : </b>{{$detail->dosis}}</p>
              <p><b>Subtotal : </b>{{$detail->subtotal}}</p>
              @if (Auth::user()->role == 'admin')
              <form action="/detail/{{$detail->id}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/detail/{{$detail->id}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
              <button type="submit" class="btn btn-default btn-xs btn-danger" value="Delete"><i class="fa fa-times"></i>Delete</button>
              </form>
              @endif
              <span class="pull-right text-muted">
              Created At - {{$detail->created_at}}</span>
