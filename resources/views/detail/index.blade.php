...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    @foreach($detail as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <a href="/detail/{{$data->id}}">{{$data->id}}</a>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Nama Obat : </b>{{$data->obat->namaobat}}</p>
              @foreach ($resep as $reseps)
              @if ($data->resep_id == 
                  $reseps->nomorresep
              )

              <p><b>Nomor Resep : </b>{{$data->resep->nomorresep}}</p>
              @endif
              @endforeach
              ...
              @if (Auth::user()->role == 'admin')
              <form action="/detail/{{$data->id}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/detail/{{$data->id}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$detail->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
