...
<form action="/detail/{{$detail->id}}" method="POST">
	...
	@foreach($resep as $data)
		...
		@if ($detail->resep_id == $data->nomorresep)
			selected 
		@endif
	...
	@foreach($obat as $data)
		...
		@if ($detail->obat_id == $data->kodeobat)
			selected 
		@endif
	...
	@endforeach
			   ...
			   <div class="form-group">
                  <label>Harga </label>
                  <input type="text" name="harga" placeholder="harga" value="{{$detail->harga}}" class="form-control">
              </div>
              <div class="form-group">
                  <label>Dosis </label>
                  <input type="text" name="dosis" placeholder="dosis" value="{{$detail->dosis}}" class="form-control">
              </div>
              <div class="form-group">
                  <label>Sub Total </label>
                  <input type="text" name="subtotal" placeholder="subtotal" value="{{$detail->subtotal}}" class="form-control">
              </div>
