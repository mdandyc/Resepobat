...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="/pembayaran/search" method="get" class="sidebar-form">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/pembayaran/create">Input</a></small>
      </h1>
    </section>
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">Nomor Bayar -
                <a href="/pembayaran/{{$pembayaran->nomorbyr}}">{{$pembayaran->nomorbyr}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Nama Pasien : </b>{{$pembayaran->pasien->namapsn}}</p>
              <p><b>Tanggal Bayar : </b>{{$pembayaran->tanggalbyr}}</p>
              <p><b>Jumlah Bayar : </b>{{$pembayaran->jumlahbyr}}</p>
              <form action="/pembayaran/{{$pembayaran->nomorbyr}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/pembayaran/{{$pembayaran->nomorbyr}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
              <button type="submit" class="btn btn-default btn-xs btn-danger" value="Delete"><i class="fa fa-times"></i>Delete</button>
              </form>
              <span class="pull-right text-muted">
              Created At - {{$pembayaran->created_at}}</span>
