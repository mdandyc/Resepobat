...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    @foreach($pembayaran as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <a href="/pembayaran/{{$data->nomorbyr}}">{{$data->nomorbyr}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <div class="box-body">
              ...
              <p><b>Tanggal Bayar : </b>{{$data->tanggalbyr}}</p>
              <p><b>Jumlah Bayar : </b>{{$data->jumlahbyr}}</p>
              <form action="/pembayaran/{{$data->nomorbyr}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/pembayaran/{{$data->nomorbyr}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$pembayaran->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
