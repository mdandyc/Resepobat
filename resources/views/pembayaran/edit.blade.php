...
@endif
<form action="/pembayaran/{{$pembayaran->nomorbyr}}" method="POST">
				...
				@if($pembayaran->pasien_id == $data->kodepsn)
					selected 
				@endif
				>{{$data->namapsn}}</option>
				@endforeach
			   ...
			   <div class="form-group">
                  ...
                  <input type="text" name="tanggalbyr" placeholder="tanggalbyr" class="form-control" value="{{$pembayaran->tanggalbyr}}">
              </div>
              <div class="form-group">
                  <label>Jumlah Bayar </label>
                  <input type="text" name="jumlahbyr" placeholder="jumlahbyr" class="form-control" value="{{$pembayaran->jumlahbyr}}">
              </div>
			</div>
