...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="/resep/search" method="get" class="sidebar-form">
...
<form action="/resep/{{$resep->nomorresep}}" method="POST">

                <div class="form-group">
                  <label>Tanggal Resep</label>
                  <input type="text" name="tanggalresep" placeholder="tanggalresep" class="form-control" value="{{$resep->tanggalresep}}">
              	</div>
              	<div class="form-group">
                  <label>Nama Pasien</label>
                  <select name="pasien_id" id="" class="form-control">
					@foreach($pasien as $data)
						<option value="{{$data->kodepsn}}"
						@if($resep->pasien_id == $data->kodepsn)
							selected 
						@endif
						>{{$data->namapsn}}</option>
					@endforeach
                  ...
                  <select name="dokter_id" id="" class="form-control">
					@foreach($dokter as $data)
						<option value="{{$data->kodedkt}}"
						@if($resep->dokter_id == $data->kodedkt)
							selected 
						@endif>{{$data->namadkt}}</option>
					@endforeach
					</select>
              	</div>
              	<div class="form-group">
                  <label>Poliklinik</label>
                  <select name="poliklinik_id" id="" class="form-control">
					@foreach($poliklinik as $data)
						<option value="{{$data->kodeplk}}"
						@if($resep->poliklinik_id == $data->kodeplk)
							selected 
						@endif
						>{{$data->namaplk}}</option>
					@endforeach
                  ...
                  <input type="text" name="totalharga" placeholder="totalharga" class="form-control" value="{{$resep->totalharga}}">
              	</div>
              	<div class="form-group">
                  <label>Bayar</label>
                  <input type="text" name="bayar" placeholder="bayar" class="form-control" value="{{$resep->bayar}}">
              	</div>
              	<div class="form-group">
                  <label>Kembali</label>
                  <input type="text" name="kembali" placeholder="kembali" class="form-control" value="{{$resep->kembali}}">
              	</div>
