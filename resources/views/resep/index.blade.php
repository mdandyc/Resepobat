...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    @foreach($resep as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <a href="/resep/{{$data->nomorresep}}">{{$data->nomorresep}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Tanggal Resep : </b>{{$data->tanggalresep}}</p>
			  <p><b>Nama Dokter : </b>{{$data->dokter->namadkt}}</p>
			  <p><b>Nama Pasien : </b>{{$data->pasien->namapsn}}</p>
			  <p><b>Poliklinik : </b>{{$data->poliklinik->namaplk}}</p>
			  <p><b>Bayar : </b>{{$data->bayar}}</p>
			  <p><b>Kembali : </b>{{$data->kembali}}</p>
			  <p><b>Total Harga : </b>{{$data->totalharga}}</p>
              <form action="/resep/{{$data->nomorresep}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/resep/{{$data->nomorresep}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$resep->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
