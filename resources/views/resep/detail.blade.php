...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/resep/create">Input</a></small>
      </h1>
    </section>
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">Nomor Resep -
                <a href="/resep/{{$resep->nomorresep}}">{{$resep->nomorresep}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Tanggal Resep : </b>{{$resep->tanggalresep}}</p>
			  <p><b>Nama Dokter : </b>{{$resep->dokter->namadkt}}</p>
			  <p><b>Nama Pasien : </b>{{$resep->pasien->namapsn}}</p>
			  <p><b>Poliklinik : </b>{{$resep->poliklinik->namaplk}}</p>
			  <p><b>Bayar : </b>{{$resep->bayar}}</p>
			  <p><b>Kembali : </b>{{$resep->kembali}}</p>
			  <p><b>Total Harga : </b>{{$resep->totalharga}}</p>
              <form action="/resep/{{$resep->nomorresep}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/resep/{{$resep->nomorresep}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
              <button type="submit" class="btn btn-default btn-xs btn-danger" value="Delete"><i class="fa fa-times"></i>Delete</button>
              </form>
              <span class="pull-right text-muted">
              Created At - {{$resep->created_at}}</span>
