...
<form action="/resep" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="tanggalresep" placeholder="tanggalresep" class="form-control">
              	</div>
              	<div class="form-group">
                  <label>Nama Pasien</label>
                  <select name="pasien_id" id="" class="form-control">
					@foreach($pasien as $data)
						<option value="{{$data->kodepsn}}">{{$data->namapsn}}</option>
					@endforeach
					</select>
              	</div>
              	<div class="form-group">
                  ...
                  <select name="dokter_id" id="" class="form-control">
					@foreach($dokter as $data)
						<option value="{{$data->kodedkt}}">{{$data->namadkt}}</option>
					@endforeach
					</select>
              	</div>
              	<div class="form-group">
                  ...
                  <select name="poliklinik_id" id="" class="form-control">
					@foreach($poliklinik as $data)
						<option value="{{$data->kodeplk}}">{{$data->namaplk}}</option>
					@endforeach
					</select>
              	</div>
              	<div class="form-group">
                  <label>Total Harga</label>
                  <input type="text" name="totalharga" placeholder="totalharga" class="form-control">
              	</div>
              	<div class="form-group">
                  <label>Bayar</label>
              	...
              	<div class="form-group">
                  <label>Kembali</label>
                  <input type="text" name="kembali" placeholder="kembali" class="form-control">
              	</div>
