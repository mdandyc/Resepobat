...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="/obat/search" method="get" class="sidebar-form">
      ...
      @if (Auth::user()->role !== 'admin')
        <li class="active">
          <a href="/obat">
            <i class="fa fa-lemon-o"></i> <span>Obat</span><span class="pull-right-container">
...
@endif
<form action="/obat/{{$obat->kodeobat}}" method="POST">

		
			   <div class="form-group">
                  <label>Nama Obat </label>
                  <input type="text" name="namaobat" placeholder="namaobat" class="form-control" value="{{$obat->namaobat}}">
              </div>
              <div class="form-group">
                  <label>Jenis Obat </label>
                  <input type="text" name="jenisobat" placeholder="jenisobat" class="form-control" value="{{$obat->jenisobat}}">
              </div>
              <div class="form-group">
                  <label>Kategori </label>
                  <input type="text" name="kategori" placeholder="kategori" class="form-control" value="{{$obat->kategori}}">
              </div>
              <div class="form-group">
                  <label>Harga Obat </label>
                  <input type="text" name="hargaobat" placeholder="hargaobat" class="form-control" value="{{$obat->hargaobat}}">
              </div>
			<div class="form-group">
                  <label>Jumlah Obat </label>
                  <input type="text" name="jumlahobat" placeholder="jumlahobat" class="form-control" value="{{$obat->jumlahobat}}">
              </div>
			</div>
