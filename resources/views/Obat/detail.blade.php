          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">{{$obat->namaobat}} -
                <a href="/obat/{{$obat->kodeobat}}">{{$obat->kodeobat}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Jenis Obat : </b>{{$obat->jenisobat}}</p>
              <p><b>Kategori : </b>{{$obat->kategori}}</p>
              <p><b>Harga Obat : </b>{{$obat->hargaobat}}</p>
              <p><b>Jumlah Obat : </b>{{$obat->jumlahobat}}</p>
              @if (Auth::user()->role == 'admin')
              <form action="/obat/{{$obat->kodeobat}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/obat/{{$obat->kodeobat}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
              <button type="submit" class="btn btn-default btn-xs btn-danger" value="Delete"><i class="fa fa-times"></i>Delete</button>
              </form>
              @endif
              <span class="pull-right text-muted">
              Created At - {{$obat->created_at}}</span>
