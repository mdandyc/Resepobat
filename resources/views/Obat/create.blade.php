...
<form action="/obat" method="POST">
			   ...
			   <div class="form-group">
                  ...
                  <input type="text" name="namaobat" placeholder="namaobat" class="form-control">
              </div>
              <div class="form-group">
                  <label>Jenis Obat </label>
                  <input type="text" name="jenisobat" placeholder="jenisobat" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="hargaobat" placeholder="hargaobat" class="form-control">
              </div>
			<div class="form-group">
                  <label>Jumlah Obat </label>
                  <input type="text" name="jumlahobat" placeholder="jumlahobat" class="form-control">
              </div>
			</div>
