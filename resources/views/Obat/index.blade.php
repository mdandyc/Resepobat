...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/obat/create">Input</a></small>
      </h1>
    </section>
    ...
    @foreach($obat as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">{{$data->namaobat}} -
                <a href="/obat/{{$data->kodeobat}}">{{$data->kodeobat}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Jenis Obat : </b>{{$data->jenisobat}}</p>
              <p><b>Kategori : </b>{{$data->kategori}}</p>
              <p><b>Harga Obat : </b>{{$data->hargaobat}}</p>
              <p><b>Jumlah Obat : </b>{{$data->jumlahobat}}</p>
              @if (Auth::user()->role == 'admin')
        
            
              <form action="/obat/{{$data->kodeobat}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/obat/{{$data->kodeobat}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$obat->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
