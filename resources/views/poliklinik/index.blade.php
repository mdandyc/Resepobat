...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    @foreach($poliklinik as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <a href="/poliklinik/{{$data->kodeplk}}">{{$data->kodeplk}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Nama Poliklinik : </b>{{$data->namaplk}}</p>
              <form action="/poliklinik/{{$data->kodeplk}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/poliklinik/{{$data->kodeplk}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$poliklinik->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
