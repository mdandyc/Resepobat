...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    @foreach($pendaftaran as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <a href="/pendaftaran/{{$data->nomorpendf}}">{{$data->nomorpendf}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Tanggal Pendfataran : </b>{{$data->tanggalpendf}}</p>
			  <p><b>Nama Dokter : </b>{{$data->dokter->namadkt}}</p>
			  <p><b>Nama Pasien : </b>{{$data->pasien->namapsn}}</p>
			  <p><b>Nama Poliklinik : </b>{{$data->poliklinik->namaplk}}</p>
              <p><b>Biaya : </b>{{$data->biaya}}</p>
              <p><b>Ket : </b>{{$data->ket}}</p>
              <form action="/pendaftaran/{{$data->nomorpendf}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/pendaftaran/{{$data->nomorpendf}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$pendaftaran->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
