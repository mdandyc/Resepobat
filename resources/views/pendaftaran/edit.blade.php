...
<form action="/pendaftaran/{{$pendaftaran->nomorpendf}}" method="POST">

				<div class="form-group">
                  <label>Tanggal Pendaftaran</label>
                  <input type="date" name="tanggalpendf" placeholder="tanggalpendf" class="form-control" value="{{$pendaftaran->tanggalpendf}}">
              </div>
				<div class="form-group">
				...
				@foreach($pasien as $data)
					...
					@if ($pendaftaran->pasien_id == $data->kodepsn)
						selected 
					@endif
		>{{$data->namapsn}}</option>
				@endforeach
				...
				@foreach($dokter as $data)
					...
					@if ($pendaftaran->dokter_id == $data->kodedkt)
						selected 
					@endif
		>{{$data->namadkt}}</option>
				@endforeach
				...
				@foreach($poliklinik as $data)
					...
					@if ($pendaftaran->poliklinik_id == $data->kodeplk)
						selected 
					@endif
		>{{$data->namaplk}}</option>
				@endforeach
			   ...
			   <div class="form-group">
                  <label>Biaya </label>
                  <input type="text" name="biaya" placeholder="biaya" class="form-control" value="{{$pendaftaran->biaya}}">
              </div>
              <div class="form-group">
                  <label>Keterangan </label>
                  <input type="text" name="ket" placeholder="ket" class="form-control" value="{{$pendaftaran->ket}}">
              </div>
