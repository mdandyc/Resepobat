...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="/pendaftaran/search" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="/dokter"><i class="fa fa-user"></i> <span>Dokter</span>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/pendaftaran/create">Input</a></small>
      </h1>
    </section>
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">Nomor Pendaftaran -
                <a href="/pendaftaran/{{$pendaftaran->nomorpendf}}">{{$pendaftaran->nomorpendf}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Tanggal Pendfataran : </b>{{$pendaftaran->tanggalpendf}}</p>
			  <p><b>Nama Dokter : </b>{{$pendaftaran->dokter->namadkt}}</p>
			  <p><b>Nama Pasien : </b>{{$pendaftaran->pasien->namapsn}}</p>
			  <p><b>Nama Poliklinik : </b>{{$pendaftaran->poliklinik->namaplk}}</p>
              <p><b>Biaya : </b>{{$pendaftaran->biaya}}</p>
              <p><b>Ket : </b>{{$pendaftaran->ket}}</p>
              <form action="/pendaftaran/{{$pendaftaran->nomorpendf}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/pendaftaran/{{$pendaftaran->nomorpendf}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
              <button type="submit" class="btn btn-default btn-xs btn-danger" value="Delete"><i class="fa fa-times"></i>Delete</button>
              </form>
              <span class="pull-right text-muted">
              Created At - {{$pendaftaran->created_at}}</span>
